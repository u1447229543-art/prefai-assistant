...
const enCore: Dict = {
  ...
  checkYourEligibility: 'Support & Benefits Finder',
  ...
  eligibilityChecker: 'Support & Benefits Finder',
  eligibilityCheckerDesc: 'Find French support and benefits you may access — short quiz.',
  catAll: 'All',
  ...
  eligibilityTitle: 'Support & Benefits Finder',
  ...
  limitReachedMsg: 'All core features are free and unlimited. Basic unlocks full Support & Benefits Finder results.',
  formal: 'Formal',
  polite: 'Polite',
  firm: 'Firm',
  tone: 'Tone',
...
const frCore: Dict = {
  ...
  checkYourEligibility: 'Aides & Soutien',
  ...
  eligibilityChecker: 'Aides & Soutien',
  ...
  eligibilityTitle: 'Aides & Soutien',
  ...
  limitReachedMsg: 'Toutes les fonctions principales sont gratuites et illimitées. Basic débloque tous les résultats d’Aides & Soutien.',
  formal: 'Formel',
  polite: 'Poli',
  firm: 'Ferme',
  tone: 'Ton',
...
const ruCore: Dict = {
  ...
  checkYourEligibility: 'Поддержка и пособия',
  ...
  eligibilityChecker: 'Поддержка и пособия',
  ...
  eligibilityTitle: 'Поддержка и пособия',
  ...
  limitReachedMsg: 'Все основные функции бесплатны и без ограничений. Basic открывает все результаты «Поддержка и пособия».',
  formal: 'Официальный',
  polite: 'Вежливый',
  firm: 'Твёрдый',
  tone: 'Тон',
