...
const enCore: Dict = {
  ...
  limitReachedMsg: 'All core features are free and unlimited. Basic unlocks full Money & Benefits Finder results.',
  formal: 'Formal',
  polite: 'Polite',
  firm: 'Firm',
  tone: 'Tone',
...
const frCore: Dict = {
  ...
  limitReachedMsg: 'Toutes les fonctions principales sont gratuites et illimitées. Basic débloque tous les résultats d’Aides & Argent.',
  formal: 'Formel',
  polite: 'Poli',
  firm: 'Ferme',
  tone: 'Ton',
...
const ruCore: Dict = {
  ...
  limitReachedMsg: 'Все основные функции бесплатны и без ограничений. Basic открывает все результаты «Деньги и пособия».',
  formal: 'Официальный',
  polite: 'Вежливый',
  firm: 'Твёрдый',
  tone: 'Тон',
