...
export const UI_I18N = {
  en: {
    ...
    askAnythingCta: 'Ask Anything',
    askAnythingDesc: 'Chat about CAF, préfecture, visas, and more',
    yourSituationHint: 'Optional — helps Ask Anything tailor answers to you.',
  ...
  fr: {
    ...
    askAnythingCta: 'Demander n’importe quoi',
    askAnythingDesc: 'Parlez CAF, préfecture, visas, et plus',
    yourSituationHint: 'Optionnel — aide Ask Anything à personnaliser les réponses.',
  ...
  ka: {
    ...
    askAnythingCta: 'იკითხე ნებისმიერი',
    askAnythingDesc: 'ჩეთი CAF, პრეფექტურა, ვიზები და სხვა',
    yourSituationHint: 'არასავალდებულო — Ask Anything-ს დაგეხმარებათ პასუხების მორგებაში.',
